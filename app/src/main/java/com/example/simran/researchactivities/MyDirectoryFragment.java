 ...
 */
public class MyDirectoryFragment extends Fragment
{
    ...
    Firebase mRef = new Firebase("https://fir-researchactivities.firebaseio.com/directory/faculty");

    public MyDirectoryFragment()
    {
