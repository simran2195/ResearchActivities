 ...
 */
public class MyDirectoryFragmentFacilities extends Fragment
{
    ...
    Firebase mRef = new Firebase("https://fir-researchactivities.firebaseio.com/directory/facility");

    public MyDirectoryFragmentFacilities()
    {
