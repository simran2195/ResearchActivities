 ...
 */
public class MyDirectoryFragmentAcademics extends Fragment
{
    ...
    Firebase mRef = new Firebase("https://fir-researchactivities.firebaseio.com/directory/academics");

    public MyDirectoryFragmentAcademics()
    {
